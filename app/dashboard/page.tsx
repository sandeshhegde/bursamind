  ...
  return (
    <div className="fade-in" style={{ maxWidth: 1400 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: "var(--text)", marginBottom: 4 }}>Market Dashboard</h1>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div style={{
            ...
            {isLive ? `Live · ${fmtTime} MYT` : "Demo Data"}
          </div>
        ...
        <div className="card">
          ...
          {gainers.map(s => (
            <Link key={s.symbol} href={`/stock/${s.symbol}`}
              style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 0", borderBottom:"1px solid var(--border)", textDecoration:"none" }}>
              <div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14, marginTop:16 }}>
        {[
          { href:"/chat",     label:"Ask Aria AI",      sub:"AI-powered insights",    color:"var(--accent)" },
          { href:"/screener", label:"Stock Screener",   sub:"Filter by fundamentals", color:"var(--blue)"   },
          { href:"/research", label:"Free Research",    sub:"Banks & Bursa reports",  color:"var(--gold)"   },
