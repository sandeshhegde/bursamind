...
// TradingView Ticker Tape — Bursa Malaysia stocks use MYX: + 4-digit numeric code
function TickerTape() {
  ...
  useEffect(() => {
    ...
    // MYX uses the 4-digit Bursa numeric code — NOT the company name
...
export default function Topbar() {
  ...
  return (
    <div style={{ background:"var(--bg2)", borderBottom:"1px solid var(--border)", position:"sticky", top:0, zIndex:50 }}>
      {/* TradingView live ticker tape — MYX numeric codes */}
      ...
      <header style={{ padding:"0 24px", height:50, display:"flex", alignItems:"center", gap:20 }}>
        <div ref={ref} style={{ position:"relative", flex:1, maxWidth:400 }}>
          <div style={{ position:"relative" }}>
            ...
            <input className="input" placeholder="Search Bursa stocks by name or code…" value={query}
